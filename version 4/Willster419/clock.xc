 ...
 */
{
  "clock": {
    ...
    // Clock format.
    // Формат часов.
    "format": "<font face='$FieldFont'><textformat leading='-38'><font size='36'>{{H%02d}}:{{m%02d}} {{AM|PM}}</font><br></textformat><textformat rightMargin='150' leading='-1'>{{WW}}<br><font size='15'>{{D%02d}} {{MM}} {{Y}}</font></textformat></font>",
    // Shadow options.
    // Параметры тени.
    "shadow": {
      // false - no shadow
